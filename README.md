...
3. [The Image Filtering Microservice](https://github.com/mucyomiller/udagram-image-filter/), the final project for the course. It is a Node-Express application which runs a simple script to process images. [My assignment]
